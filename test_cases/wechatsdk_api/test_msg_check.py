...
from utils.other_tools.models import WeChatApi
...
class TestMsgCheck:
    ...
    def test_init(self):
        ...
        interface_calls = DataAnalysis.get_interface_data(data, WeChatApi.WX_MSG_CHECK_PATH.value)
        assert interface_calls, f"{WeChatApi.WX_MSG_CHECK_PATH.value} 没有正常调用"
